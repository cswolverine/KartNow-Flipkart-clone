...
public class SignUpActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void signUpUser() {
        ...
        if (email.isEmpty()) {
            ...
            binding.inputEmailLayout.setErrorEnabled(true);
        ...
        if (Validation.isValidEmail(email)) {
            ...
            binding.inputEmailLayout.setErrorEnabled(false);
        ...
        if (!Validation.isValidEmail(email)) {
            //binding.inputEmail.setError(getString(R.string.enter_a_valid_email_address));
            binding.inputEmailLayout.setError(getString(R.string.enter_a_valid_email_address));
            binding.inputEmailLayout.setErrorEnabled(true);
            binding.userEmail.requestFocus();
            return;
        }
        ...
        if (password.isEmpty()) {
            //binding.inputEmail.setError(getString(R.string.email_required));
            binding.inputPasswordLayout.setError(getString(R.string.password_required));
            binding.inputPasswordLayout.setErrorEnabled(true);
        ...
        if (Validation.isValidPassword(password)) {
            ...
            binding.inputPasswordLayout.setErrorEnabled(false);
            //binding.inputEmail.requestFocus();
        }
        if (!password.isEmpty()) {
            //binding.inputEmail.setError(getString(R.string.email_required));
        ...
        if (!Validation.isValidPassword(password)) {
            //binding.inputEmail.setError(getString(R.string.enter_a_valid_email_address));
            binding.inputPasswordLayout.setError(getString(R.string.password__at_least_8_characters));
            binding.inputPasswordLayout.setErrorEnabled(true);
            binding.userPassword.requestFocus();
            return;
        }
