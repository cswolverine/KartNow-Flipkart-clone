...
public interface Api {
    ...
    @GET("orders")
    Call<OrderProductApiResponse> getProductsInOrder(@Query("orderId") int orderId);
    @GET("orders/get")
    ...
    @POST("orderedProduct/add")
    Call<ResponseBody> ordereringProduct(@Body OrderedProducts orderedProducts);
}
